...
public class GaugeView extends View {
    ...
    private void readAttrs(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        mShowText = a.getBoolean(R.styleable.GaugeView_gvShowText, SHOW_TEXT);
    ...
    public void setDefaultRanges() {
        mRangeValues = new float[]{16, 25, 40, 100, 160};
        mRangeColors = new int[]{Color.rgb(231, 32, 43), Color.rgb(232, 111, 33), Color.rgb(232, 231, 33), Color.rgb(27, 202, 33), Color.rgb(255, 0, 0)};
    }
